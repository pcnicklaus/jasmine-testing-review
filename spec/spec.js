...
//     expect(code.oddNumbersForty(45)).toBe([41, 43]);
//     expect(code.oddNumbersForty(50)).toBe([41,43,45,47,49]);
//     });
// });
...
//     expect(code.evenNumbersHundred(7)).toBe([0,2,4,6]);
//     expect(code.evenNumbersHundred(6)).toBe([0,2,4,6]);
//   });
// });
...
//     expect(code.oddNumbersAndMore(47)).toBe([41,43,45,47]);
//     expect(code.oddNumbersAndMore(37)).toBe([40,39,38,37]);
//   });
// });
...
describe('problem 8', function() {
  it('takes two numbers and returns the least common multiple of them');
      expect(code.lcd(14,10)).toBe(70);
});
...
//     expect(code.averageAndDeviation(5,10)).toBe(["7.5 average","2.5 SD"]);
//     expect(code.averageAndDeviation(30,50)).toBe(["40 average","10 SD"]);
//   });
// });
